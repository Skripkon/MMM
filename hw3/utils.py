...
def get_image_path_by_parent_asin(parent_asin: str) -> str:
    return f"../hw2/data/images/{parent_asin}.jpg"


def load_image_by_parent_asin(parent_asin: str) -> Image.Image:
    path = get_image_path_by_parent_asin(parent_asin)
